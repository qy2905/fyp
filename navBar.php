<nav class="navbar navbar-expand-md navbar-light bg-white " style="background-color:white;">
    <div id="menu" class="navbar-collapse collapse w-100 order-1 order-md-0 dual-collapse2 container-fluid">
        <ul class="navbar-nav mr-auto">
            <center><a class="navbar-brand mx-auto" href="#"><img src="media/osmosis learn logo.png" alt="Logo"
